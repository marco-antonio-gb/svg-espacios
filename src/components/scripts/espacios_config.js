...
export default {
	methods: {
		...
		drawSemiprivados(width, height, fakePadding, columns, rows, draw) {
			...
			var xsp1 = columns * width - 2 * fakePadding + 1;
			...
			var ysp2 = height * 11.7;
			var rectsp2 = draw
				.rect(width * 2 + fakePadding, height * 2 + fakePadding)
				.fill("#fff")
				.move(fakePadding * 8, height * 10.7)
				.radius(8)
				.stroke({
					width: 2,
					color: "#c5cbd4"
			...
			var xsp3 = fakePadding;
			var ysp3 = height * 14.2;
			var rectsp3 = draw
				.rect(width * 2 + fakePadding, height * 2 + fakePadding)
				.fill("none")
				.move(fakePadding * 8, height * 13 + fakePadding - 5)
				.radius(8)
				.stroke({
					width: 2,
					color: "#c5cbd4"
				});
			rectsp3.attr("id", "SP2-A");
			var txtsp3 = draw
				.plain("BANOS")
				.attr({
					x: xsp3 + width * 4.5 / 2,
